const initUserGrid = () => {
    ...
    const userGrid = new Grid({
        ...
        columns: [
            ...
            { header: '주소', name: 'address1', align: 'center', minWidth: 200, flex: 2 },
            { header: '상세주소', name: 'address2', align: 'center', minWidth: 150, flex: 2 },
            { header: '우편번호', name: 'postcode', align: 'center', minWidth: 100, flex: 1 },
